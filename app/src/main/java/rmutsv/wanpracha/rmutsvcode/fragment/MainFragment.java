...
import rmutsv.wanpracha.rmutsvcode.GetAllData;
import rmutsv.wanpracha.rmutsvcode.MyAlert;
import rmutsv.wanpracha.rmutsvcode.R;
import rmutsv.wanpracha.rmutsvcode.ServiceActivity;
...
public class MainFragment extends Fragment{
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (userString.equals("")||passwordString.equals("")) {
                    ...
                    myAlert.myDialog("มีช่องว่างคราบ", "กรุณากรอกให้ครบทุกช่อง");
    ...
    private void checkUserAndPass() {
        ...
        String tag = "4JulyV2";
        String urlPHP = "http://androidthai.in.th/piw/getAllUserBow.php";
        boolean b = true;
